          ...
          >
            {loading ? (
              <div className="p-4 text-center">
                <IconLoader2 className="w-5 h-5 animate-spin mx-auto text-[#FF6B6B]" />
              </div>
            ) : results.length > 0 ? (
              <div className="p-1.5">
                {results.map((movie) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left min-w-0">
                      <h3
                        ...
                        className="font-semibold text-white text-sm truncate group-hover:text-[#FF6B6B] transition-colors"
                      >
                        {movie.Title}
                      </h3>
                      <p
                    ...
                    <IconChevronRight className="w-4 h-4 text-[#6B7280] group-hover:text-[#FF6B6B] transition-colors shrink-0" />
                  </button>
                ))}
              </div>
            ) : (
