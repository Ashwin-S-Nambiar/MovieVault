    ...
    >
      ...
      <div className="relative aspect-2/3 overflow-hidden bg-[#1A1F2B]">
        ...
        {movie.imdbRating && movie.imdbRating !== 'N/A' && (
          <div className="absolute top-2 right-2 bg-black/70 backdrop-blur-sm px-2 py-1 rounded-md flex items-center gap-1 shadow-lg">
            <IconStarFilled className="w-3 h-3 text-[#FFD700]" />
            <span
      ...
      <div className="p-2.5">
        <h3
          ...
          className="text-sm font-semibold text-white mb-1.5 line-clamp-1 group-hover:text-[#FF6B6B] transition-colors duration-300"
        >
          {movie.Title}
        </h3>
