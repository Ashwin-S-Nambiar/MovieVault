...
import { convertTmdbToOmdbFormat, getMovieDetails } from '../utils/tmdbApi';
...
const MoviePage = () => {
  ...
  const isInWatchlist =
    movie && watchlist.some((m) => m.imdbID === movie.imdbID);
            ...
            >
              ...
              <div className="mb-6">
                ...
                {movie.Tagline && movie.Tagline !== 'N/A' && (
                  <p
                    style={{ fontFamily: 'var(--font-sans)' }}
                    className="text-lg text-[#9CA3AF] italic flex items-center gap-2"
                  >
                    <IconSparkles className="w-4 h-4 text-[#FF6B6B]" />
                    {movie.Tagline}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                ...
                {movie.Year && (
                  <div className="flex items-center gap-2 bg-[#242938] px-4 py-2 rounded-lg border border-white/5">
                    <IconCalendar className="w-4 h-4 text-[#9CA3AF]" />
                    <span
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-[#F5F6FA]"
                    >
                      {movie.Year}
                    </span>
                  </div>
                ...
                {movie.Runtime && movie.Runtime !== 'N/A' && (
                  <div className="flex items-center gap-2 bg-[#242938] px-4 py-2 rounded-lg border border-white/5">
                    <IconClock className="w-4 h-4 text-[#9CA3AF]" />
                    <span
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-[#F5F6FA]"
                    >
              ...
              <div className="mt-auto">
                ...
                >
                  {isInWatchlist ? (
                    <>
                      <IconMinus className="w-5 h-5" /> Remove from Watchlist
                    </>
                  ) : (
                    <>
                      <IconPlus className="w-5 h-5" /> Add to Watchlist
                    </>
                  )}
                </motion.button>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <h2
                ...
                className="font-semibold text-white mb-6 flex items-center gap-2"
              >
                <IconUsers className="w-5 h-5 text-[#FF6B6B]" />
                Cast & Crew
              </h2>
              <div className="space-y-4">
                {movie.Actors && movie.Actors !== 'N/A' && (
                  <div>
                    <h3
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-sm font-semibold text-[#9CA3AF] uppercase tracking-wider mb-2"
                    >
                      Cast
                    </h3>
                    <p
                ...
                {movie.Director && movie.Director !== 'N/A' && (
                  <div>
                    <h3
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-sm font-semibold text-[#9CA3AF] uppercase tracking-wider mb-2 flex items-center gap-2"
                    >
            ...
            <div className="bg-[#242938] rounded-2xl p-6 border border-white/5 space-y-4">
              ...
              {movie.Language && movie.Language !== 'N/A' && (
                <div className="flex items-start gap-3">
                  <IconWorld className="w-5 h-5 text-[#FF6B6B] mt-0.5 shrink-0" />
                  <div>
                    <h4
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-sm font-semibold text-[#9CA3AF] mb-1"
                    >
                      Language
                    </h4>
                    <p
              ...
              {movie.Country && movie.Country !== 'N/A' && (
                <div className="flex items-start gap-3">
                  <IconTag className="w-5 h-5 text-[#FF6B6B] mt-0.5 shrink-0" />
                  <div>
                    <h4
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-sm font-semibold text-[#9CA3AF] mb-1"
              ...
              {movie.Awards && movie.Awards !== 'N/A' && (
                <div className="flex items-start gap-3">
                  <IconAward className="w-5 h-5 text-[#FF6B6B] mt-0.5 shrink-0" />
                  <div>
                    <h4
                      style={{ fontFamily: 'var(--font-sans)' }}
                      className="text-sm font-semibold text-[#9CA3AF] mb-1"
